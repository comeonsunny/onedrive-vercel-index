...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'sunny@ph74.onmicrosoft.com',
  ...
  title: "Sunny's Websites",

  // The folder that you are to share publicly with onedrive-vercel-index. Use '/' if you want to share your root folder.
  baseDirectory: '/TOFFEL',
  ...
  links: [
    ...
    {
      name: 'Telegram',
      link: 'https://t.me/Changqischolar',
    },
  ],
